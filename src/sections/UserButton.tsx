...
const NeonUserButton = styled.div`
  ...
  height: 40px;
  border-radius: 12px;
  background: linear-gradient(90deg, #ffe600ff, #fbff00ff);
  box-shadow: 0 0 24px #eeff00aa, 0 0 48px #fffb00aa;
  ...
  &:focus {
    background: linear-gradient(90deg, #ffe600ff, #fbff00ff);
    box-shadow: 0 0 32px #ffe600ff, 0 0 64px #fbff00ff;
    outline: none;
  }
`;
...
export const neonPulse = keyframes`
  0% { box-shadow: 0 0 24px #eeff00aa, 0 0 48px #fffb00aa; border-color: #eeff00aa; }
  100% { box-shadow: 0 0 48px #eeff00cc, 0 0 96px #fffb00cc; border-color: #fffb00cc; }
`;
...
export const ModalContent = styled.div`
  ...
  &::after {
    ...
    right: 0;
    height: 4px;
    background: linear-gradient(90deg, #ffee00ff, #fffb00ff, #fffb00ff);
        ...
        >
          ...
          <div
            style={{
              ...
              padding: "1rem",
              margin: "1rem 0",
              boxShadow: "0 0 32px rgba(251, 255, 0, 0.12)",
            }}
          >
            ...
            >
              <b style={{ color: "#fbff00ff" }}>Token Balance:</b>{" "}
            ...
            <p
              style={{ color: "rgba(255,255,255,0.9)", marginBottom: "0.5rem" }}
            >
              <b style={{ color: "#fbff00ff" }}>Bonus Balance:</b>{" "}
              {(
