...
const neonPulse = keyframes`
  0% { 
    ...
    border-color: #fbff0044;
  }
  100% { 
    box-shadow: 0 0 48px #fffb00cc, 0 0 96px #a259ff88;
    border-color: #ffee00aa;
  }
`;
...
const ModalContentStyled = styled.div`
  ...
  overflow-y: auto;
  position: relative;
  box-shadow: 0 0 40px rgba(255, 238, 0, 0.12);
  ...
  &::after {
    ...
    right: 0;
    height: 4px;
    background: linear-gradient(90deg, #fbff00ff, #fbff00ff, #fffb00ff);
...
const ModalTitle = styled.h2`
  ...
  text-shadow: 0 0 10px #eeff00ff, 0 0 20px #fbff00ff,
